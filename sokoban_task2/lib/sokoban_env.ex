defmodule SokobanEnv do
  @moduledoc """
  Environment configuration helper for Sokoban multi-user platform.
  ...
  """
  def cors_origins do
    get("CORS_ORIGINS", "http://localhost:4000,http://localhost:4001")
    |> String.split(",")
